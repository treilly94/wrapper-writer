...
parser_wrap.add_argument('-m', '--method-config', default=None, help='The path to the method config file')
parser_wrap.add_argument('-s', '--structure-config', default=None, help='The path to the structure config file')
